...
import travelPackage.menuSystem.SeaSystemManager;
...
public class SampleSeaClient {
    public static void main(String[] args) {
        ...
        res.createCruise("DEL", "DEN", "LON", dateStart3, dateFinish3, "567"); //invalid travelPackage.airline
        ...
        res.createSection("SWSERTT","123", 200, 5, CabinType.DC);//Invalid travelPackage.airline
        res.bookSeat("123", CabinType.F);
        res.bookSeat("123", CabinType.C);
        res.bookSeat("123", CabinType.DC);
        res.bookSeat("123", CabinType.DF);//Invalid travelPackage.airline
