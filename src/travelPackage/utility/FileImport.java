...
import travelPackage.airline.factories.AirlineFactory;
import travelPackage.airline.factories.AirportFactory;
import travelPackage.airline.factories.FlightFactory;
import travelPackage.airline.SeatClass;
import travelPackage.airline.seats.SectionLayout;
...
public class FileImport {
    ...
    public ArrayList<travelPackage.airline.Airport> buildPorts(String[] ports){
    ...
    public ArrayList<travelPackage.airline.Airline> buildLines(ArrayList<ArrayList<String>> lines){
        AirlineFactory factory = new AirlineFactory();
        for(ArrayList<String> line : lines){
            if(!factory.getCompanies().contains(new travelPackage.airline.Airline(line.get(0))))
                factory.createCompany(line.get(0));
        }
        return factory.getCompanies();
    }

    public ArrayList<travelPackage.airline.Flight> buildFlights (ArrayList<ArrayList<String>> flights){
