...
import travelPackage.menuSystem.AirSystemManager;
...
//        res.createFlight("DEL", "DEN", "LON", 2016, 9, 8, "567"); //invalid travelPackage.airline
...
//        res.createFlight("AMER", "DEN", "LON", 2010, 40, 100, "123abc");// invalid date
        ...
        res.createSection("SWSERTT","123", 5, 5, SeatClass.E);//Invalid travelPackage.airline
//        res.bookSeat("DELTA", "123", SeatClass.F, 1, 'A');
//        res.bookSeat("DELTA", "123", SeatClass.E, 1, 'A');
//        res.bookSeat("DELTA", "123", SeatClass.E, 1, 'B');
//        res.bookSeat("DELTA888", "123", SeatClass.B, 1, 'A');//Invalid travelPackage.airline
